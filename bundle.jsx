  ...
  return (
    <div style={{
      ...
      <main>
        ...
        {/* HERO */}
        <section id="momento" style={{ minHeight: "100vh", display: "flex", alignItems: "center", padding: "120px 64px 80px", position: "relative", overflow: "hidden" }}>
        ...
        {/* O MERCADO REGULOU */}
        <section style={{ padding: "120px 64px", background: "linear-gradient(180deg, #0e1620 0%, #0e1620 35%, #111b28 100%)", position: "relative" }}>
